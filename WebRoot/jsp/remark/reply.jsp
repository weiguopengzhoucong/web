		...
		<div id="contanier">
			...
			<div id="main">
				<form action="#" method="post" id="form1" 
					name="form1">
					<input type="hidden" id="id" name="remark.id" value="${remark.id}"/>
					<input type="hidden"  name="type" value="${remark.type}"/>
					...
					<div class="column">
						...
						<s:if test="remark.childRemark!=null">
							<label>
							<span class="col_text">我的回复：</span>
							<textarea rows="5" cols="80" readonly="readonly"><s:property value="%{remark.childRemark.content}"/></textarea>
							</label>
						</s:if>
						<s:else>
							<label>
							<span class="col_text">回复内容：</span>
							<textarea rows="5" cols="80" name="remark.content" id="content"></textarea>
							</label>
						</s:else>
					</div>
