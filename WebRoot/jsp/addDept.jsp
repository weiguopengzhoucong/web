...
<body>
	<div id="layout" class="fn-clear">
		...
		<div id="contanier">
			...
			<div id="main">
				<form action="deptAction!saveDept.do" method="post" id="form1" enctype="multipart/form-data"
					name="form1">
					<div class="column">
						<input
							type="hidden" name="dept.shangquanid"
							id="dept.shangquanid" value="${shangquanid}"/> 
						<h3>添加机构</h3>

						<label> <span class="col_text">名称：</span> <input
							type="text" name="dept.deptname"
							id="dept.deptname" class="label_text_370" /> <em> 注：限20字以内</em> 
						</label> 
						<label> <span class="col_text">地址：</span> <input
							type="text" name="dept.address"
							id="dept.address" class="label_text_370" /> <em> 注：限20字以内</em> 
						</label> 
                        <label>
                        <span class="col_text">电话：</span>
                        <input
							type="text" name="dept.tel"
							id="dept.tel" class="label_text_370" /> <em> 注：限20字以内</em> 
                        </label>
                        <label>
                        ...
                        <input
							...
							id="dept.x" class="label_text_370" /> <em> 注：限20字以内</em> 
                        </label>
                        <label>
                        <span class="col_text">纬度：</span>
                        <input
							type="text" name="dept.y"
							id="dept.y" class="label_text_370" /> <em> 注：限20字以内</em> 
                        </label>
						<label> <span class="col_text">简介：</span> 
						<textarea rows="15" cols="70" name="dept.content" id="dept.content"></textarea>
						</label> 
						<label>     
					...
					<textarea rows="30" cols="50" name="fileUpload" id="content"></textarea>
				</form>
				<input type="image"
