...
<body>
	<div id="layout" class="fn-clear">
		...
		<div id="contanier">
			...
			<div id="main">
				<form action="newsAction!insertTeacherNews.do" method="post" id="form1" enctype="multipart/form-data"
					name="form1">
					<div class="column">
						<input type="hidden" name="news.Type" id="news.Type" class="label_text_370" value="教师简介新闻" />
