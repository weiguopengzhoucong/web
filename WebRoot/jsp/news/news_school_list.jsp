        		...
        		<table cellpadding="0" cellspacing="0" width="100%">
                	<tr>
	             		<td width="30%" align="left" >
	             			 <a href="newsAction!addSchoolNews.do">添加</a>
	             		</td>
                 ...
                 <div >
                    	<jsp:include page="../page.jsp">
							<jsp:param name="url" value="<%=path+"/newsAction!newsSchoolList.do"%>"/>
						</jsp:include>
                    </div>
...
<script type="text/javascript">
	...
	function goUpdate(id){
		var url = "<%=path %>/newsAction!updateSchoolNewsById.do?id="+id;
		window.location.href = url;
	}
	
	function onsearch(){
		var search = $("#search").val();
		var url = "<%=path %>/newsAction!schoolNewsList.do?search="+search;
		window.location.href = url;
	}
	     	...
	     	url: "newsAction!delete.do?id="+id,
	      	success: function(msg){
	      		 if(msg==0){
	      		 	...
	      		 	alert("删除成功");
	      		 	var url = "<%=path%>/newsAction!schoolNewsList.do";
	        	 	window.location.href = url;
	      		 }
	     		}
	  		});
