        		...
        		<table cellpadding="0" cellspacing="0" width="100%">
                	<tr>
	             		<td width="30%" align="left" >
	             			 <a href="newsAction!addNews.do">添加</a>
	             		</td>
                 ...
                 <div >
                    	<jsp:include page="../page.jsp">
							<jsp:param name="url" value="<%=path+"/newsAction!newsList.do"%>"/>
						</jsp:include>
                    </div>
...
<script type="text/javascript">
	...
	function onsearch(){
		...
		var url = "<%=path %>/newsAction!newsList.do?search="+search;
		window.location.href = url;
	}
	
	function goUpdate(id){
		var url = "<%=path %>/newsAction!updateNews.do?id="+id;
		window.location.href = url;
	}
	     	...
	     	url: "newsAction!delete.do?id="+id,
	      	success: function(msg){
	      		 if(msg==0){
	      		 	...
	      		 	alert("删除成功");
	      		 	var url = "<%=path%>/newsAction!newsList.do";
	        	 	window.location.href = url;
	      		 }
	     		}
	  		});
