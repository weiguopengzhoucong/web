...
<body>
	<div id="layout" class="fn-clear">
		...
		<div id="contanier">
			...
			<div id="main">
				<form action="newsAction!insertSchoolNews.do" method="post" id="form1" enctype="multipart/form-data"
					name="form1">
					<div class="column">
						<input type="hidden" name="news.Type" id="news.Type" class="label_text_370" value="校区环境新闻" />
