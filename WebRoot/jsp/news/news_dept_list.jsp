        		...
        		<table cellpadding="0" cellspacing="0" width="100%">
                	<tr>
	             		<td width="30%" align="left" >
	             			 <a href="newsAction!addDeptNews.do">添加</a>
	             		</td>
...
<script type="text/javascript">
	...
	function goUpdate(id){
		var url = "<%=path %>/newsAction!updateDeptNewsById.do?id="+id;
		window.location.href = url;
	}
	
	function onsearch(){
		var search = $("#search").val();
		var url = "<%=path %>/newsAction!newsDeptList.do?search="+search;
		window.location.href = url;
	}
	     	...
	     	url: "newsAction!delete.do?id="+id,
	      	success: function(msg){
	      		 if(msg==0){
	      		 	...
	      		 	alert("删除成功");
	      		 	var url = "<%=path%>/newsAction!newsDeptList.do";
	        	 	window.location.href = url;
	      		 }
	     		}
	  		});
