...
<body>
	<div id="layout" class="fn-clear">
		...
		<div id="contanier">
			...
			<div id="main">
				<form action="newsAction!insert.do" method="post" id="form1" enctype="multipart/form-data"
					name="form1">
					<div class="column">
						<input type="hidden" name="news.Type" id="news.Type" class="label_text_370" value="平台新闻" />
...
<!-- 							<input type="file" id="upload" name="news.url" class="upload_img_btn" -->
<!-- 								style="width:200px;" -->
