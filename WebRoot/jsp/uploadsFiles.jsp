...
<body>
	...
	<s:form action="fileUpload" method="POST" name="pos"
		...
		<table width="80%" border="1" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td width="20%" align="right"><font color="red">*</font>上传图片文件

				</td>

				<td width="20%"><s:file name="myFile"></s:file> <s:hidden
						name="imagefile" value="movie"></s:hidden> <s:submit value="上传"></s:submit>
			</tr>
