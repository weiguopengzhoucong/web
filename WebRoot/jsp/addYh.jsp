		...
		<div id="contanier">
			...
			<div id="main">
				<form action="#" method="post" id="form1" 
					name="form1">
					<input type="hidden" id="deptorcourse" name="yh.deptorcourse" value="${deptorcourse}"/>
        			<input type="hidden" id="deptorcourseid" name="yh.deptorcourseid" value="${deptorcourseid}"/>
					<div class="column">
						...
						<label> <span class="col_text">名称：</span> <input
							...
							id="yh.name" class="label_text_370" /> <em> 注：限20字以内</em> 
						</label> 
						<label>
						...
						<textarea rows="3" cols="50" name="yh.content" id="content"></textarea>
						</label>
					</div>
