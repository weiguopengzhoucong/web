...
(function () {
	var r = function (c, j) {
		...
		var f = 1, k = /^\s*(\d+)((px)|\%)?\s*$/i, v = /(^\s*(\d+)((px)|\%)?\s*$)|^$/i, o = /^\d+px$/, w = function () {
			...
			if ("check" == b) {
				if (!a.userlockRatio && "true" == d.getCustomData("isReady")) {
					var e = a.getValueOf("info", "txtWidth"), c = a.getValueOf("info", "txtHeight"), d = 1000 * d.$.width / d.$.height, f = 1000 * e / c;
					a.lockRatio = !1;
		...
		return {title:c.lang.image["image" == j ? "title" : "titleButton"], minWidth:420, minHeight:360, onShow:function () {
			...
			if (b && "img" == b.getName() && !b.data("cke-realelement") || b && "input" == b.getName() && "image" == b.getAttribute("type")) {
