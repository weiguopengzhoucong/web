		     ...
		     <div class="list_wrap">
					...
					<ul class="course_list">
						<li class="course_item">
							...
							<div class="address">
								...
								<a class="gotomap" href='<%=basePath + "IndexAction!forward.do?_value=map&id="%><s:property value="id"/>'>地图</a>
							...
							<div class="pic_area">
								...
								<img alt="" src="<%=basePath%><s:property value="url" escape="false" />" width="140px;" height="110px;" /> 
								<a target="parent" href="<%=basePath + "IndexAction!DeptDetail.do?id="%><s:property value="id"/>">
									<s:property value="deptname" />
								</a>
							</div>
							<div class="free_area">
				...
				<div class="page_wrap">
					...
					<jsp:include page="/frontJsp/page.jsp">
						<jsp:param name="url"
							value="<%=basePath+"IndexAction!clickTopValue.do"%>" />
						<jsp:param name="type"
							value="<%=request.getParameter("type")%>" />
						<jsp:param name="areaid"
							value="<%=request.getParameter("areaid")%>" />
						<jsp:param name="shangquanid"
							value="<%=request.getParameter("shangquanid")%>" />
						<jsp:param name="order"
